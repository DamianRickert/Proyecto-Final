...
@section ('contenido')
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			...
			{!!Form::model($cliente,['method'=>'PATCH','route'=>['ventas.cliente.update',$cliente->cl_id_cliente]])!!}
			{{Form::token()}}
			...
			<div class="form-group">
				<label for="tipo_docuemento">Tipo Documento</label>
				<input type="text" name="cl_tipo_documento" class="form-control" value="{{$cliente->cl_tipo_documento}}" placeholder="Tipo Docuemento...">
			</div>
			<div class="form-group">
