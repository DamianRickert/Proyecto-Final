...
@section ('contenido')
	...
	<div class="row">
		<div class="col-lg-2 col-sm-2 col-md-2 col-xs-12"> 
			<div class="form-group">
				...
				<input id="adherente" type="radio" name="cl_tipo_cliente" value="2">
					Adherente
				</input>
			</div>
		</div>
	...
	<div class="row">
		<div class="col-lg-2 col-sm-2 col-md-2 col-xs-12"> 
			<div class="form-group">
				...
				<select name="cl_n_cuenta" id="cl_n_cuenta" class="form-control selectpicker" data-live-search="true">
					<option value=""></option>
					@foreach($titulares as $tit)
						<option value="{{$tit->cl_n_cuenta}}">{{$tit->cl_nombre}} - {{$tit->cl_n_cuenta}}</option>
					@endforeach
				</select>
			</div>
		</div>
	...
	<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12"> 
	 	<div class="form-group">
			...
			<a href=""><button class="btn btn-warning" onclick="location.href='create_adherente'" type="submit">Agregar Adherente</button></a>
...
@push ('scripts')
<script>
	$("#cl_n_cuenta").prop('disabled', false);

	$("#titular").click(function(){
		$("#cl_n_cuenta").prop('disabled', true);
	})

	$("#adherente").click(function(){
		$("#cl_n_cuenta").prop('disabled', false);
	})
</script>
@endpush
